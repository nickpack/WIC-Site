...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Album.cover'
        db.alter_column('wic_album', 'cover', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'BandMember.avatar'
        db.alter_column('wic_bandmember', 'avatar', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    models = {
        'wic.album': {
