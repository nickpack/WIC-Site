...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.flickr_id'
        db.alter_column('wic_photo', 'flickr_id', self.gf('django.db.models.fields.BigIntegerField')())
    def backwards(self, orm):

        # Changing field 'Photo.flickr_id'
        db.alter_column('wic_photo', 'flickr_id', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'wic.album': {
